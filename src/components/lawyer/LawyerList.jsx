...
import { Search, Filter, Star, DollarSign, ShieldAlert, ArrowRight, Eye } from 'lucide-react';
...
export default function LawyerList({ lawyers = [] }) {
    ...
    // Filter Logic based on DB user properties
    const filteredLawyers = lawyers.filter((lawyer) => {
        ...
        const matchesCategory =
            selectedCategory === 'All' || specialization.includes(selectedCategory);
            ...
            {filteredLawyers.length === 0 ? (
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
                    {filteredLawyers.map((lawyer) => {
                        const targetId = lawyer?._id;
                        const avatarSrc = lawyer?.image  || 'https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&q=80&w=250';
                        const hourlyRate = lawyer?.fee || '0';
                        const isBusy = lawyer?.isBusy || false;
                                ...
                                <div className="space-y-3 text-center">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-slate-400 line-clamp-1 mt-0.5">
                                            {lawyer?.specialization || 'General Legal Practitioner'}
                                        </p>
                                    </div>
