    ...
    return (
        <div className="relative w-full">
            <div className="w-full bg-[#0d1527] rounded-2xl border border-slate-800 shadow-xl overflow-hidden text-slate-200">
                {/* Table Header */}
                <div className="p-4 sm:p-6 border-b border-slate-800/80 bg-[#0f192e] flex items-center justify-between">
                    <div>
                ...
                {users.length === 0 ? (
                    ...
                    <>
                        {/* 1. Mobile & Small Screen Card Layout (Hidden on Md and larger screens) */}
                        <div className="grid grid-cols-1 gap-4 p-4 md:hidden">
                            {users.map((user, index) => {
                                ...
                                return (
                                    <div
                                        key={userId}
                                        className="bg-[#0b1222] border border-slate-800 rounded-xl p-4 space-y-4"
                                    >
                                        {/* User Info & Index */}
                                        <div className="flex items-center justify-between border-b border-slate-800/80 pb-3">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className="overflow-hidden">
                                                    <div className="font-semibold text-white text-sm truncate max-w-[170px]">
                                                        {user.name || "N/A"}
                                                    </div>
                                        ...
                                        {/* Current Role Badge & Action Controls */}
                                        <div className="flex items-center justify-between gap-2 text-xs">
                                            ...
                                            <div className="flex items-center gap-2">
                                                <select
                                                    ...
                                                    className="bg-[#090d16] border border-slate-700 text-slate-200 text-xs rounded-lg focus:ring-1 focus:ring-amber-500 block p-1.5 cursor-pointer disabled:opacity-50 outline-none"
                                                >
                                                ...
                                                <button
                                                    ...
                                                    className="text-xs font-medium text-red-400 hover:text-red-300 bg-red-950/30 hover:bg-red-900/50 border border-red-800/50 px-2.5 py-1.5 rounded-lg transition-all disabled:opacity-50"
                                                >
                                                    {isProcessing && loadingId === userId ? "..." : "Delete"}
                                                </button>
                                            </div>
                                        </div>
                                    </div>
            ...
            {isDeleteModalOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fadeIn">
                    <div className="w-full max-w-md bg-[#0f192e] border border-slate-800 rounded-2xl p-5 sm:p-6 shadow-2xl space-y-5">
                        ...
                        <div className="flex items-center justify-end gap-3 text-xs font-medium">
                            <button
                                ...
                                className="px-3.5 py-2 text-slate-300 hover:text-white bg-slate-800/60 hover:bg-slate-800 border border-slate-700/60 rounded-xl transition-colors disabled:opacity-50"
                            >
                                Cancel
                            </button>
                            <button
